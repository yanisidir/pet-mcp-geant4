...
void PlotElectronMomenta(
  // Default path assumes this macro is launched from the project root.
  const char* fileName = "build/mcp_output.root")
{
  ...
  DrawMomentum(
    ...
    "Electron X momentum in the +z MCP stack",
    componentNames[kDirectionX], "Fig/current/plus_stack_dirx_by_mcp.png");
  DrawMomentum(
    plates, kDirectionY, "plusStackDirectionYCanvas",
    "Electron Y momentum in the +z MCP stack",
    componentNames[kDirectionY], "Fig/current/plus_stack_diry_by_mcp.png");
  DrawMomentum(
    plates, kDirectionZ, "plusStackDirectionZCanvas",
    "Electron Z momentum in the +z MCP stack",
    componentNames[kDirectionZ], "Fig/current/plus_stack_dirz_by_mcp.png");
