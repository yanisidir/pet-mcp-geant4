...
void plot_multiplicities(const char* fileName = "build/mcp_output.root")
{
  ...
  hProduced->Draw("HIST");
  c1->SaveAs("Fig/current/produced_electron_multiplicity.png");
  ...
  hChannel->Draw("HIST");
  c2->SaveAs("Fig/current/channel_electron_multiplicity.png");
  ...
  c3->SaveAs("Fig/current/electron_multiplicity_comparison.png");
