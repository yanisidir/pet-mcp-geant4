  ...
  const char* fileName = "build/mcp_output.root")
{
  ...
  multiplicityCanvas->SaveAs("Fig/current/coincidence_multiplicity.png");
  ...
  correlationCanvas->SaveAs(
    "Fig/current/coincidence_plus_vs_minus_percent.png");
  ...
  if (!plusIndices.empty() && !minusIndices.empty()) {
    ...
    plateCanvas->SaveAs("Fig/current/coincidence_plate_matrix.png");
  }
  ...
  if (!gammaPlateOrder.empty()) {
    ...
    firstGammaCanvas->SaveAs(
      "Fig/current/coincidence_gamma_first_interaction_by_plate.png");
  }
  ...
  if (!yieldPlateOrder.empty()) {
    ...
    eventYieldCanvas->SaveAs(
      "Fig/current/coincidence_plate_detection_yield.png");
    ...
    electronYieldCanvas->SaveAs(
      "Fig/current/coincidence_plate_electron_yield.png");
  }
