  ...
  const char* fileName = "build/mcp_output_t0.root")
{
  ...
  TLeaf* leaves[kNumberOfVariables] = {
    FindLeaf(tree, {"x_cm", "x", "posX", "positionX"},
             branchNames[kX]),
    FindLeaf(tree, {"y_cm", "y", "posY", "positionY"},
             branchNames[kY]),
    FindLeaf(tree, {"z_cm", "z", "posZ", "positionZ"},
             branchNames[kZ]),
  ...
  DrawNormalizedHistograms(
    ...
    branchNames[kZ],
    "plus_stack_z_position_by_mcp.png");
  ...
  DrawNormalizedHistograms(
    ...
    branchNames[kX],
    "plus_stack_x_position_by_mcp.png");
  ...
  DrawNormalizedHistograms(
    ...
    branchNames[kY],
    "plus_stack_y_position_by_mcp.png");
  ...
  DrawNormalizedHistograms(
    ...
    branchNames[kX],
    "plus_stack_x_position_zoom.png",
    true,
    kUseLogScaleForZoom);
  ...
  DrawNormalizedHistograms(
    ...
    branchNames[kY],
    "plus_stack_y_position_zoom.png",
    true,
    kUseLogScaleForZoom);

  DrawElectronCounts(
    plates, "plus_stack_electron_count_by_mcp.png");
