  ...
  const char* fileName = "build/mcp_output_t0.root")
{
  ...
  DrawPosition(
    ...
    coordinateNames[kX], "plus_stack_x_position_by_mcp.png");
  DrawPosition(
    plates, kY, "plusStackYCanvas",
    "Electron Y position in the +z MCP stack",
    coordinateNames[kY], "plus_stack_y_position_by_mcp.png");
  DrawPosition(
    plates, kZ, "plusStackZCanvas",
    "Electron Z position in the +z MCP stack",
    coordinateNames[kZ], "plus_stack_z_position_by_mcp.png");
